...
{
    private const PACKAGE     = 'etechflow/module-store-locator';
    private const LATEST_URL  = 'https://license-service.etechflow.com/composer/latest/etechflow/module-store-locator.json';
    private const CACHE_KEY   = 'etechflow_rs_update_check';
    private const CACHE_TTL   = 21600;
    private const MODULE_NAME = 'Etechflow_StoreLocator';
    ...
    public function execute(Observer $observer): void
    {
        try {
            ...
            $title = (string) __('eTechFlow Store Locator %1 is available', $latest['version']);
