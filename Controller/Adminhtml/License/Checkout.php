...
class Checkout extends Action
{
    ...
    public function execute(): ResultInterface
    {
        ...
        $gate = $this->resultFactory->create(ResultFactory::TYPE_REDIRECT)->setPath('etechflow_storelocator/license/gate');
        ...
        $payload = json_encode([
            ...
            'magento_callback' => $this->getUrl('etechflow_storelocator/license/activated'),
            'magento_cancel'   => $this->getUrl('etechflow_storelocator/license/gate'),
        ]);
