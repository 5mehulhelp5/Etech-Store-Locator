...
namespace Etechflow\StoreLocator\Test\Unit\Model;
...
class LicenseValidatorTest extends TestCase
{
    ...
    public function testExplicitRevokeFlagWinsOverEverything(): void
    {
        ...
        $this->setConfig([
            LicenseValidator::XML_PATH_LICENSE_KEY => 'SP-live-abc123',
            LicenseValidator::XML_PATH_PORTAL_API_URL => self::PORTAL,
            'etechflow_storelocator/license/revoked' => '1',
        ]);
        $this->setCacheMiss();
    ...
    public function testForgedKeyAndAttackerControlledConfigCannotBypass(): void
    {
        ...
        $this->setConfig([
            ...
            // Every field the removed local-grace/HMAC path used to trust, all forged.
            'etechflow_storelocator/license/issued_key'        => 'SP-i-made-this-up',
            'etechflow_storelocator/license/issued_at'         => (string) time(),
            'etechflow_storelocator/license/ip_blocked'        => '0',
            'etechflow_storelocator/license/enforce_on_dev'    => '0',
            'etechflow_storelocator/license/production_environment' => '0',
        ]);
    ...
    public function testGraceFromPriorSuccessKeepsStorefrontLiveWhilePortalUnreachable(): void
    {
        ...
        $graceKey = 'etf_sl_lic_grace_' . md5($host . ':' . $key);
    ...
    public function testGraceDoesNotApplyToADifferentHost(): void
    {
        ...
        $goodGraceKey = 'etf_sl_lic_grace_' . md5('shop.example.com:SP-live-abc123');
        $this->cache->method('load')->willReturnCallback(
